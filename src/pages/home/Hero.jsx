...
const Hero = () => {
  return (
    <section className=" bg-pearl-50 mt-16 md:mt-0 pb-6 md:pt-24 md:pb-20 px-6 gap-5 md:px-12 lg:px-24 flex flex-col md:flex-row justify-center items-center h-screen">
